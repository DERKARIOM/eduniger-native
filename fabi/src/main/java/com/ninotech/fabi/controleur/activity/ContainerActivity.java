            ...
            case 2: // Audio Book
                try {
                    ...
                    do {
                        ...
                        // Convertir le tableau d'octets en Bitmap
                        Bitmap bitmap = BitmapFactory.decodeByteArray(imageBytes, 0, imageBytes.length);
                        audioBooks.add(new AudioBook(audioCursor.getString(2),bitmap,audioCursor.getString(8),audioCursor.getString(4),audioCursor.getString(11),audioCursor.getString(6)));
